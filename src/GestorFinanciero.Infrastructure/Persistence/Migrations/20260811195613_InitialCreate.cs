        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    current_balance_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ...
                    minimum_payment_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    minimum_payment_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    estimated_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    actual_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateOnly>(type: "date", nullable: false),
                    minimum_payment_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    minimum_payment_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    extra_payment_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    extra_payment_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    ...
                    remaining_balance_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    remaining_balance_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_budget_items_BudgetId_CategoryId",
                table: "budget_items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_debt_payments_DebtId_Date",
                table: "debt_payments",
